...
* This dataset now has all the necessary variables to perform the NCA in complete cases for maternal and partner variables to do the mutually adjusted models
save mp2_nca.dta, replace
