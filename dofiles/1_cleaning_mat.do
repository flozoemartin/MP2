...
* Data cleaning of maternal data extract (ALSPAC) from 08/02/2021 for mini project 2 - alcohol during pregnancy and HDP *
...
save "$Datadir/mp2_clean.dta", replace
...
* Save clean dataset including those with complete exposure & covariate data n=8,999
save "$Datadir/mp2_cca.dta", replace
